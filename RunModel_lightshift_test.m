...
%%% This script has paramter Shift_start adjusted by 12h to test how a
%%% phase shift including a 24h dark period is different from the original
%%% simulationn that included a 24h light period.  NJK 12/8/15
...
while w<=xaa  
    ...
    Phase_shift=12;  %%% How many hours to advance earlier the 24h circadian rhythm. Positive shifts lengthen the intermediate periods (phase delay).
